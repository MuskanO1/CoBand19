...
class HealthParameters:
    ...
    def update_data(self):
        self.hr_value += random.randint(-20, 20) / 10
...
# create an object of the class HealthParameters

student1 = HealthParameters("jatin", 100, 98, 98.6)

student2 = HealthParameters("testinglol", 85, 97, 98.9)
